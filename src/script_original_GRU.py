...
model5.add(Embedding(nb_words + 1,
                     ...
                     input_length = max_question_len,
                     trainable = False))
model5.add(keras.layers.recurrent.GRU(units, activation='tanh', recurrent_activation='hard_sigmoid', use_bias=True, kernel_initializer='glorot_uniform', recurrent_initializer='orthogonal', bias_initializer='zeros', kernel_regularizer=None, recurrent_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, recurrent_constraint=None, bias_constraint=None, dropout=0.25, recurrent_dropout=0.25))
...
model6.add(Embedding(nb_words + 1,
                     ...
                     input_length = max_question_len,
                     trainable = False))
model6.add(keras.layers.recurrent.GRU(units, activation='tanh', recurrent_activation='hard_sigmoid', use_bias=True, kernel_initializer='glorot_uniform', recurrent_initializer='orthogonal', bias_initializer='zeros', kernel_regularizer=None, recurrent_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, recurrent_constraint=None, bias_constraint=None, dropout=0.25, recurrent_dropout=0.25))
...
modela = Sequential()
modela.add(Merge([model1, model3, model5], mode='concat'))
modela.add(Dense(units*3, kernel_initializer=weights, bias_initializer=bias))
...
modelb = Sequential()
modelb.add(Merge([model2, model4, model6], mode='concat'))
modelb.add(Dense(units*3, kernel_initializer=weights, bias_initializer=bias))
